...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : HALL1_C_Pin HALL0_C_Pin */
  GPIO_InitStruct.Pin = HALL1_C_Pin|HALL0_C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : ENCODE_A_Pin ENCODE_B_Pin HALL0_A_Pin HALL0_B_Pin
                           HALL1_A_Pin HALL1_B_Pin */
  GPIO_InitStruct.Pin = ENCODE_A_Pin|ENCODE_B_Pin|HALL0_A_Pin|HALL0_B_Pin
                          |HALL1_A_Pin|HALL1_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
